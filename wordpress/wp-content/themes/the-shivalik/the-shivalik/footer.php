				...
				<div class="block">
					...
					<div class="block-body">
						<figure class="foot-logo">
							<img src="<?php bloginfo('template_directory');?>/images/logo-light.png" class="img-responsive" alt="Logo">
						</figure>
					...
					<div class="block-body">
						...
						<article class="article-mini">
							...
							<div class="inner">
								...
								<div class="padding">
									<h1><a href="<?php the_permalink();?>"><?php the_title();?></a></h1></div>
								</div>
							</article>
								<?php
								endwhile;
...
printf( esc_html__( 'Theme: %1$s by %2$s.', 'the-shivalik' ), 'the-shivalik', '<a href="http://underscores.me/">Underscores.me</a>' );
?>
</div><!-- .site-info -->
</footer><!-- #colophon -->
</div><!-- #page -->
